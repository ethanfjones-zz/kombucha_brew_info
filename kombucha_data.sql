...
( 11, 
  ...
  2,
  3, 
  "Increased sugar in hopes of increasing rate of fermentation"), 
( 12, 
  2.75,
  73.0, 
  2,
  2.5, 
  "No bag used for tea, ran out of cane sugar so had to use refined sugar."), 
( 13, 
  NULL,
  73.5, 
  2,
  2.5, 
  "No bag w/ tea and trying to convert to metric in log book.");
...
( 11, 
  ...
  74.0,
  NULL, 
  "Still not happy with fermentation rate."), 
( 12, 
  74.0,
  78.0,
  76.0,
  ...
  76.0,
  76.0, 
  "Missed alot of temperatures b/c I was on vacation.");
...
( 11,
  "1 Gallon w/ 3 tsp grated ginger, 1.5 TBSP honey, 1/2 lime squeezed. Rest plain. ", 
  3, 
  "Great taste, nice fuzy feeling."), 
( 12,
  "1 Gallon w/ 3/4 Cups fresh lemon juice, 19g  shredded basil. 1/2 Gallon 5g hops from backyard, 1/4 Cup bottled lime juice.", 
  3, 
  "Lemon Basil - Vert tart. Not much external flavor. Think SCOBY is up to full potential. In future can wait less time. Alternativley lemon flavor might be overbearing and acidic. Hlime - not much taste other then kombucha. Should have dried hopes before")